  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        disabled: cn('text-muted opacity-70', defaultClassNames.disabled),
...
const CalendarDayButton = ({
  ...
  return (
    <Button
      ...
      className={cn(
        `relative isolate z-10 flex aspect-square size-auto w-full min-w-(--cell-size) flex-col gap-1 leading-none group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 [&>span]:text-xs [&>span]:opacity-70`,
        defaultClassNames.day,
        className,
      )}
      {...props}
