...
export default function Home() {
  ...
  return (
    <div className="relative flex flex-col min-h-screen items-start justify-start bg-background gap-5">
      <ThemeSwitcher />
      ...
      {/* Content */}
      <div className="flex flex-col w-full gap-12 px-6 pt-5 pb-24">
        {/* Colours */}
